...
All models can be fitted using 3 different model fitting engines, SpATS, lme4 
and asreml. For models with rowcol or res.rowcol design SpATS is the default 
