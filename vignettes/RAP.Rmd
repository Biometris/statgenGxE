...
was performed in two locations in Chili, Santa Rosa and Cauquenes, with two 
...
using the function `STRunModel`. Depending on the design of the trial several 
...
`STRunModel` uses three different engines for fitting the models, namely
...
fitting only one so when fitting models on large datasets it is sensible to use 
