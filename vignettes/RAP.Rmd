...
res.rowcol design SpATS is the default engine, for the other models lme4. 
This can be overruled by the function parameter `engine`.
...
plot on the model object. A plot will always be made for 1 trait in 1 trial for
...
model objects. This `report` function will create a pdf report describing the 
...
```
Similar to plotting a model object reporting is also done for 1 trait in 1 trial 
