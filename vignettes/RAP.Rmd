...
for the (groups of) trials can be ordered using `orderBy`. Boxed can be ordered by external vector or by the group mean.
```{r boxPlotGR}
...
smoothing with P-splines as described in @Lee2013 and in @Rodriquez2017. See `help(PSANOVA, SpATS)`
