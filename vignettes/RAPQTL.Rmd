...
A more convenient way is to directly convert the output of a model fitted using ```fitTD``` into an object of class cross using the function ```SSAtoCross```. For the examp
