...
Note that for the both factor analytic models to be fitted a minimum of 5 environments are needed. If the data contains less environments those two models are skipped.
...
```
As can be seen in the column Mega Factor in the output 4 mega environments have been created. In the environments SR_FI_11 and SR_MWS_11 G276 is the best genotype so those two environments have been clustered together. The other three environments have different winning genotypes and therefore are in their own mega environment.
