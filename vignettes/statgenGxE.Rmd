...
| environmental dimensions | model | parameters |
|:-----------|:-------------------|:------------|
...
In all models the random part of the model is printed **bold**.     
...
plot(dropsVarComp)
```
It is possible to make predictions based on the fitted model using the `predict` function. Predictions can be made on different levels, specified by the parameter `predictLevel`.
