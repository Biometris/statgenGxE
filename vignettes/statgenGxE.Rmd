...
$y_{ij} = \mu + g_i + \Sigma_k\delta_{ik}\gamma_{j} + \epsilon_{ij}; \epsilon_{ij} \sim N(0, \sigma^2_\epsilon)$.
...
$y_{ij} = \mu + g_i + e_j \Sigma_k\delta_{ik}\gamma_{jk} + \epsilon_{ij}; \epsilon_{ij} \sim N(0, \sigma^2_\epsilon)$.
...
$y_{ij} = \mu + e_j \Sigma_k\delta_{ik}\gamma_{jk} + \epsilon_{ij}; \epsilon_{ij} \sim N(0, \sigma^2_\epsilon)$.
...
```{r geStabMegaEnv, R.options=list(digits=3)}
...
The models fitted are of the form $y_{ij} = \mu_{i} + \epsilon_{ij}$, where the variance of $\epsilon_{ij}$ is modeled in the follwing ways:
