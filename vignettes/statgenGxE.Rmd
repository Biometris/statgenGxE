...
A heat map of the correlation between the environments based on the best fitted model can be plotted. It will be instructive to compare the fitted correlations of tis section with the 'observed' correlations in section [1](#dp) and the GGE biplot in section [5](#gge). Comparisons with the mixed models in section [2](#vcomp) are also relevant.
