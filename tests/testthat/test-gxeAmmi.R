...
test_that("anova is correct", {
  ...
  expect_equal(as.numeric(as.matrix(geAmmi$anova)),
               c(14, 2, 28, 15, 13, 0, 7644.67782855106, 513.074183597498,
                 8671.41494683825, 5798.79270973584, 2872.62223710241, 0,
                 546.048416325076, 256.537091798749, 309.693390958509,
                 386.586180649056, 220.97094131557, NaN, 1.76319040789034,
                 0.828358303045345, NA, NaN, NaN, NA, 0.0980192661103099,
                 0.447187338385732, NA, NaN, NaN, NA))
})
