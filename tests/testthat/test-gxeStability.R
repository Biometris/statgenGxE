...
test_that("superiority is computed correctly", {
  ...
  expect_equal(sup$superiority,
               c(3940.5397803278, 3022.21904080722, 2598.17364359058,
                 2588.49105583387, 2518.79370648346, 2473.14071610774,
                 2429.67282734051, 2362.07050030342, 2189.94273125631,
                 2024.78044718482, 1986.14147273499, 1501.97635189109,
                 1422.63335221524, 1290.79686509336, 1179.03818107474))
  expect_equal(sup$mean,
               c(54.2031334320118, 66.2676045412444, 71.7251608269665,
                 73.0871656828908, 73.2435501712991, 75.3836554703585,
                 74.4525075789223, 74.8374571665672, 80.6390175697029,
                 81.4068278048538, 81.921276388438, 92.20470759419,
...
test_that("static is computed correctly", {
  ...
  expect_equal(sta$static,
               c(1236.22441699745, 938.239475056893, 571.795429941847,
                 340.869668436155, 311.134712234077, 238.270628556254,
                 199.929473556735, 141.550914632088, 120.073390965768,
                 98.2382041653228, 85.1891664482231, 72.908961978567,
                 58.8949470780672, 53.127398526111, 3.53601858128704))
  expect_equal(sta$mean,
               c(81.4068278048538, 97.3247024025305, 74.8374571665672,
                 94.1532040202908, 80.6390175697029, 54.2031334320118,
                 92.20470759419, 75.3836554703585, 74.4525075789223,
                 73.0871656828908, 71.7251608269665, 81.921276388438,
...
test_that("wricke is computed correctly", {
  ...
  expect_equal(wri$wricke,
               c(1902.30490526853, 1576.34662172865, 834.192141954125,
                 788.464006957686, 732.907499302012, 518.182498059668,
                 472.642532486111, 279.929271802651, 271.933243518989,
                 259.20458428707, 257.053039154622, 182.110068850864,
                 122.341672845375, 114.89546943427, 55.2006334326454))
  expect_equal(wri$mean,
               c(81.4068278048538, 97.3247024025305, 80.6390175697029,
                 74.8374571665672, 94.1532040202908, 92.20470759419,
                 75.3836554703585, 73.0871656828908, 74.4525075789223,
                 54.2031334320118, 81.921276388438, 73.2435501712991,
...
test_that("option trials functions properly", {
  ...
  expect_equal(geStabTr$superiority$superiority,
               c(3796.36028162954, 2591.78800746145, 2536.44454355594,
                 ...
                 1876.21906178712, 1689.29635634906, 1552.25119351059,
                 1461.31850004353, 1385.26490439232, 1315.91595541124,
                 798.771853936756, 795.397572610451, 735.585495003539))
})
...
test_that("option bestMethod for superiority is computed correctly", {
  ...
  expect_equal(supMin$superiority,
               c(1990.71087049962, 1670.54267372833, 1563.5969077264,
                 1549.85254273757, 1134.77672117742, 1112.14443245264,
                 1039.13064351809, 829.308210462886, 734.896555792387,
                 726.653499212872, 678.140843270401, 665.157598405587,
                 569.239996165416, 413.996898302837, 133.941993486244))
  expect_equal(supMin$mean,
               c(97.3247024025305, 94.1532040202908, 93.6809432528475,
                 92.20470759419, 81.4068278048538, 80.6390175697029,
                 81.921276388438, 75.3836554703585, 74.4525075789223,
                 74.8374571665672, 73.2435501712991, 73.0871656828908,
...
modelSp <- fitTD(testTD, design = "rowcol", traits = "t2")
BLUEs <- SSAtoTD(modelSp, what = "BLUEs")
geMegaEnv <- gxeMegaEnv(TD = BLUEs, trait = "t2", sumTab = FALSE)
geStabME <- gxeStability(TD = geMegaEnv, trait = "t2", useMegaEnv = TRUE)
test_that("option useMegaEnv functions properly", {
  expect_error(gxeStability(TD = testTD, trait = "t2", useMegaEnv = TRUE),
               "megaEnv has to be a column in TD")
  expect_equal(geStabME$superiority$superiority,
               c(0.996127269193415, 0.956040885735583, 0.91519431104132,
                 0.768349459038868, 0.713398948632969, 0.644948073924003,
                 0.575778069229778, 0.574344409304285, 0.553810810615217,
                 0.457574657681855, 0.437421558399408, 0.383816260659395,
                 0.378011627705469, 0.329671553982545, 0.0599373789454586))
})
