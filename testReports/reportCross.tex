...
\hypersetup
{
pdfsubject={Cross report},
pdftitle={Cross report}
}
...
{\centering \includegraphics[width=\maxwidth]{figures/fig-sumPlots-1} 
\includegraphics[width=\maxwidth]{figures/fig-sumPlots-2} 
...
{\centering \includegraphics[width=\maxwidth]{figures/fig-recomPlot-1} 
...
Mean number of recombinations per chromosome per individual: 2.67% latex table generated in R 3.4.3 by xtable 1.8-2 package
% Tue Jan 02 09:54:49 2018
\begin{table}[ht]
\begin{flushleft}
...
{\centering \includegraphics[width=\maxwidth]{figures/fig-crossover-1} 
