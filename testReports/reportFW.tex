...
\includegraphics[width=0.9\linewidth]{./figures/032618142949-linePlot-1} \hfill{}
...
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}
\includegraphics[width=0.9\linewidth]{./figures/032618142949-scatterPlot-1} 
