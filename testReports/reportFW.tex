...
\includegraphics[width=0.7\linewidth]{./figures/011518120107-linePlot-1} \hfill{}
...
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}
\includegraphics[width=\maxwidth]{./figures/011518120107-scatterPlot-1} 
