...
\includegraphics[width=0.9\linewidth]{./figures/021618150750-linePlot-1} \hfill{}
...
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}
\includegraphics[width=0.9\linewidth]{./figures/021618150750-scatterPlot-1} 
