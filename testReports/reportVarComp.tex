...
%-------------------------------------------------------------------------------
\begin{table}[ht]\begin{flushleft}\caption{Covariance matrix for the best model}% latex table generated in R 3.5.1 by xtable 1.8-2 package
% Tue Jul 24 09:35:09 2018
...
\includegraphics[width=10cm,height=10cm]{./figures/072418093509-heatmap-1} \hfill{}
