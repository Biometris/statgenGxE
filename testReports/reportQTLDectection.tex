...
% Thu Jan 18 14:13:27 2018
\begin{table}[ht]
\begin{flushleft}
\begin{tabular}{ll}
  Modeling date & 18-01-18 \\ 
  Modeling time & 14:13:27 \\ 
...
\label{model}
\begin{tabular}{ll}
  Model type & Composite interval mapping \\ 
  Method & Hayley Knot \\ 
  \end{tabular}
\end{flushleft}
\end{table}
...
\includegraphics[width=\maxwidth]{./figures/011818141327-profile-1} \hfill{}
