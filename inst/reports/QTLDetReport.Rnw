...
modSum <- data.frame(c("Model type", "Method"),
                     c(switch(x$type, "MR" = "Marker response",
                               "SIM" = "Simple interval mapping",
                               "CIM" = "Composite interval mapping"),
                       "Hayley Knot"))
print(xtable::xtable(x = modSum, label = "model",
                     align = c("l", "l", "l")),
      latex.environments = "flushleft", hline.after = NULL,
...
summaryTab <- x$peaks
print(xtable::xtable(x = summaryTab, caption = "List of peaks",
                     label = "summary",
                     align = c("l", "r", "r", "r"),
                     digits = c(0, 0, 0, 2)),
...
%-------------------------------------------------------------------------------
<<label=profile, echo=FALSE, fig.align="left">>=
plot(x)
@
%-------------------------------------------------------------------------------
% End Document
