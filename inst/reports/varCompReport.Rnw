...
\hypersetup
{
pdfsubject={Variance component analysis report},
pdftitle={Variance component analysis report}
}
...
print(xtable::xtable(x = summaryTab, caption = paste("Models tried ordered by",
                                                     x$criterion),
                     label = "summary",
                     align = c("l", "r", "r", "r", "r"),
                     digits = 0),
