...
Use the `summary` function to get an idea of the content of the data in the `TD` object. Multiple traits may be summarised at once but for clarity here a summary is
only made for GY.
```{r TDsum}
...
See the vignette "GxE analysis using RAP"" for an overview of how to use the input just 
created for performing GxE analysis.
